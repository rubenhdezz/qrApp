(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_scanner_scanner_module_ts"],{
...
/* harmony import */ var _scanner_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scanner.page */ 3253);
...
/* harmony import */ var _scanner_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scanner-routing.module */ 1159);
/* harmony import */ var _scanner_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scanner.page */ 3253);
...
/* harmony import */ var _scanner_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scanner.page.html?ngResource */ 7030);
/* harmony import */ var _scanner_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scanner.page.scss?ngResource */ 3950);
...
let ScannerPage = class ScannerPage {
    constructor(toastCtrl, loadingCtrl, router, plt) {
    ...
    ngOnDestroy() {
        var _a;
        (_a = this.collaboratorSubscription) === null || _a === void 0 ? void 0 : _a.unsubscribe();
    }
    ngAfterViewInit() {
    ...
    showQrToast() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            const toast = yield this.toastCtrl.create({
                message: 'Trabajador no encontrado, intente de nuevo con otro código.',
                position: 'top',
                buttons: [
                    {
                        text: 'cerrar',
    ...
    stopScan() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            this.scanActive = yield false;
            yield this.videoElement.srcObject.getTracks().forEach(function (track) {
                track.stop();
            });
        });
    }
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            if (this.videoElement.readyState === this.videoElement.HAVE_ENOUGH_DATA) {
                ...
                if (code) {
                    ...
                    if (!isNaN(Number(this.scanResult))) {
                        this.scanActive = false;
                        //BUSCAR USUARIO CON API
                    }
                }
                else {
                    if (this.scanActive) {
...
ScannerPage = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        selector: 'app-scanner',
        template: _scanner_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_scanner_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], ScannerPage);
...
/***/ 3950:
/*!******************************************************!*\
  !*** ./src/app/scanner/scanner.page.scss?ngResource ***!
  \******************************************************/
/***/ ((module) => {

"use strict";
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzY2FubmVyLnBhZ2Uuc2NzcyJ9 */";

/***/ }),

/***/ 7030:
/*!******************************************************!*\
  !*** ./src/app/scanner/scanner.page.html?ngResource ***!
  \******************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-back-button (click)=\"stopScan()\" text=\"Regresar\"></ion-back-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <!-- Shows our camera stream -->\n  <video #video width=\"100%\"></video>\n\n  <!-- Used to render the camera stream images -->\n  <canvas #canvas hidden></canvas>\n\n</ion-content>\n";

/***/ })

}]);
//# sourceMappingURL=src_app_scanner_scanner_module_ts.js.map